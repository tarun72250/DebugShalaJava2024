...
public class OperatorExample {
	...
	public static void main(String[] args) {
		...
		int h , i , j ;
		h = 10 ; i = 5 ; j = 20;
		System.out.println(h<i & j>i); //Bitwise and :- return false (Both condition are false)
		System.out.println(h>i | j<i); //Bitwise or :- return true (One condition true return true)
		System.out.println(h<j ^ j<i);  //Bitwise xor :- return false  (one condition true return true)
